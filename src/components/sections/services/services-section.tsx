              ...
              <Reveal key={service.title} delay={index * 0.08}>
                ...
                >
                  <Link href={service.link} className="block h-full">
                    <Card className="group relative min-h-[250px] cursor-pointer rounded-[26px] border border-[#d4b06a]/20 bg-[#341042]/60 p-8 backdrop-blur-md transition-all duration-500 hover:border-[#d4b06a]/70 hover:shadow-[0_0_60px_rgba(212,176,106,0.35)]">
                      {/* Glow */}
                      <div className="pointer-events-none absolute inset-0 opacity-0 transition-opacity duration-500 group-hover:opacity-100">
                        <div className="absolute inset-0 rounded-[26px] border border-[#d4b06a]/40 shadow-[0_0_80px_rgba(212,176,106,0.35)]" />
                      </div>
