...
const tocItems: { id: string; label: string }[] = [
  ...
  ...[
    ...
    "5. Client Content & Responsibility",
    ...
    "12. Indemnification",
    "13. Service Suspension & Termination",
    "14. Force Majeure",
...
function TableOfContents() {
  ...
  return (
    <nav aria-label="Terms & Conditions contents" className="text-sm">
            ...
            <div className="mt-14 lg:grid lg:grid-cols-[250px_minmax(0,1fr)] lg:gap-14 xl:gap-20">
              ...
              <div className="space-y-16 text-[16px] leading-8 text-zinc-300">
                ...
                <PolicySection title="6. Third-Party Integrations">
                  <p>
                    Services may rely on third-party providers, platforms, APIs, hosting services,
                    or infrastructure.
                  </p>
                ...
                <PolicySection title="9. AI & Automation Disclaimer">
                  <p>
                    AI-generated outputs, automation workflows, recommendations, or
                    machine-generated results may contain errors, inaccuracies, or incomplete
                    information.
                  </p>
                ...
                <PolicySection title="11. Limitation of Liability">
                  ...
                  <p className="mt-6">
                    Total liability, if any, shall not exceed the amount paid for the relevant
                ...
                <PolicySection title="12. Indemnification">
                  <p>
                    Users agree to defend, indemnify, and hold harmless<b>Gelora Tech </b>from
                    claims, liabilities, damages, losses, costs, or legal expenses arising from:
                  </p>
